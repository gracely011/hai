...
// Flag tunggal untuk mencegah double alert
window.isKickedFlag = false;

function handleMultiLoginKick(message) {
    if (window.isKickedFlag) return; // Stop jika sudah pernah dipanggil
    window.isKickedFlag = true;
